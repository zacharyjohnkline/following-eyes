  ...
  if (document.body.style.cursor !== "pointer") {
    setTimeout(() => {
      if (
        ...
        `url("images/FLY_CURSOR_LARGE.gif"), default`
      ) {
        document.body.style.cursor = `url('images/FLY_CURSOR_LARGE2.gif'), default`;
        animateCursor();
      } else if (
        document.body.style.cursor ===
        `url("images/FLY_CURSOR_LARGE2.gif"), default`
      ) {
        document.body.style.cursor = `url('images/FLY_CURSOR_LARGE.gif'),default`;
        animateCursor();
      } else {
        clearTimeout();
      }
